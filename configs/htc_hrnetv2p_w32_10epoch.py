...
data = dict(
    ...
    test=dict(
        type='CocoDataset',
        ann_file=
        '/workspace/data/Chula-ParasiteEgg-11/labels_test_with_masks.json',
...
log_level = 'INFO'
load_from = 'pretrained_models/htc_hrnetv2p_w32_20e_coco_20200207-7639fa12.pth'
resume_from = None
workflow = [('train', 1)]
...
work_dir = './work_dirs/htc_hrnetv2p_w32_10e_chulacell'
auto_resume = False
gpu_ids = range(0, 2)
