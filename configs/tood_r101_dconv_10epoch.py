...
data = dict(
    ...
    train=dict(
        type='CocoDataset',
        ann_file=[
            '/workspace/data/Chula-ParasiteEgg-11/labels_train.json',
            '/workspace/data/Chula-ParasiteEgg-11/labels_val.json',
    ...
    val=dict(
        type='CocoDataset',
        ann_file='/workspace/data/Chula-ParasiteEgg-11/labels_val.json',
...
log_level = 'INFO'
load_from = 'pretrained_models/tood_r101_fpn_dconv_c3-c5_mstrain_2x_coco_20211210_213728-4a824142.pth'
resume_from = None
workflow = [('train', 1)]
...
classes = ('Ascaris lumbricoides', 'Capillaria philippinensis',
           ...
           'Trichuris trichiura')
work_dir = './work_dirs/tood_r101_fpn_dconv_c3-c5_mstrain_1x_chulacell'
auto_resume = False
gpu_ids = range(0, 2)
