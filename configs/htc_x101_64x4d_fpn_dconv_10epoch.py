...
data = dict(
    ...
    train=dict(
        ...
        ann_file=[
            ...
            '/workspace/data/Chula-ParasiteEgg-11/labels_test_fusion_929_with_masks.json'
        ],
        img_prefix=[
...
log_level = 'INFO'
load_from = 'pretrained_models/htc_x101_64x4d_fpn_dconv_c3-c5_mstrain_400_1400_16x1_20e_coco_20200312-946fd751.pth'
resume_from = None
workflow = [('train', 1)]
...
work_dir = './work_dirs/htc_x101_64x4d_fpn_dconv_c3-c5_mstrain_400_1400_16x1_10e_chulacell'
auto_resume = False
gpu_ids = range(0, 2)
